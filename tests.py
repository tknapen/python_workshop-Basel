...
def test_create_array_with_zeros(arr):
    ...
    try:
        ...
        print(
            "Your array has the wrong shape, namely %r, but I expected %r"
            % (
                arr.shape,
                c_answer.shape,
            )
...
def test_fill_array_with_complement(arr):
    ...
    try:
        ...
        print(
            "Your array (%r) does not match the correct answer (%r)!" % (arr, c_answer)
        )
        raise (e)
    else:
        print("Well done!")
...
def test_bloodpressure_index(arr):
    ...
    try:
        ...
        print(
            "The result of your indexing operation is of shape %r, "
            "while it should be %r, namely 20 subjects by 24 hours"
            % (arr.shape, (20, 24))
        )
        raise (e)
    ...
    try:
        ...
        print(
            "Your answer is not correct! Did you perhaps forget that Python has zero-based indexing? (First index is 0!)"
        )
        raise (e)
...
def test_boolean_indexing(arr):
    ...
    my_array = np.array([[0, 1, -1, -2], [2, -5, 1, 4], [10, -2, -4, 20]])
...
def test_tvalue_computation(arr, h0, tval_ans):
    ...
    try:
        ...
        print(
            "T-value is incorrect! Your t-value is %.3f, while it should be %.3f"
            % (tval_ans, c_tval)
        )
        raise (e)
...
def test_array_product_and_sum(arr):
    ...
    try:
        ...
        print(
            "Your answer is incorrect! I got:\n\n%r\n\nbut I expected:\n\n%r"
            % (arr, c_answer)
        )
        raise (e)
    else:
...
def test_compute_range_vectorized(arr, ans):
    ...
    try:
        ...
        print(
            "The shape of your answer is incorrect! I got %r, "
            "but I expected %r for input-array of shape %r"
            % (ans.shape, c_answer.shape, arr.shape)
        )
        raise (e)
    ...
    try:
        ...
        print(
            "Your answer is incorrect! Your answer is:\n\n%r/n/n But I expected:\n\n%r"
            % (ans, c_answer)
        )
        raise (e)
